...
안녕하세요! 카이스트 인공지능 대학원, 데이터 시각화 연구실의 석사과정에 재학중인 이호준이라고 합니다. 강화학습을 공부하는데 있어 정말 좋은 영어 자료들은 많지만, 이해가 쉽게 되지 않을때면 한글로된 자료가 부족한것이 큰 아쉬움으로 남았습니다. 이번에 같은 연구실의 이병근 학우와 Sergey Levine교수님의 **CS 285: Deep Reinforcement Learning, Decision Making, and Control**을 공부하며 배운 내용들을 노트로 정리하고자 합니다. 이 강의를 공부하시는 분들에게 조금이라도 도움이 되기를 소망합니다. 노트들은 CS 285 강의를 기본으로 하되 흐름에 맞게 내용들을 추가하고 재배치했음을 밝힙니다. 부족한점에 대한 지적과 질문은 자유롭게 댓글로 남겨주세요.

<script type="text/javascript" src="https://cdn.mathjax.org/mathjax/latest/MathJax.js?config=TeX-AMS-MML_HTMLorMML"></script>

이번 포스팅에서는 앞으로의 강의에서 어떤 내용들을 다룰지 소개하는 시간을 갖습니다. 첫번째 강의인만큼 이론적인 설명은 크게 없어 가벼운 마음으로 보기 좋을것 같습니다.
...
하지만, 이러한 지도학습 방법론은 우리가 실제로 행동하며 학습하는 방법과는 큰 차이가 있습니다. 우리들은 살아가며 다양한 의사결정들을 수행합니다. 하지만, 과연 어떠한 결정이 올바른 선택이었는지 명확하게 구분짓는 것은 정말 어렵습니다. 우리는 시간이 지나고 나서야만 그 당시 마주했던 다양한 상황들을 되돌아보며 선택을 평가할 수 있을 뿐입니다. 

<center><img src = "/assets/images/cs285/lecture1/mdp.png" width = "300"></center><br>

강화학습은 지도학습으로는 쉽게 모델링할 수 없는 우리의 연속된 의사결정들을 모델링하고 평가하기 위한 알고리즘입니다. 인공지능 모델에게 언제나 정답을 알려주는 직접적인 선생님이 있는것이 아닌, 스스로의 경험을 통해서 어떠한 선택이 올바른 선택이었는지 알아내는 것입니다. 저희의 인공지능 agent는 주어진 environment에서 observation에 따라 action을 통해서 reward을 받고, 그 reward을 합을 최대화 하는 방향으로 학습을 진행하는 것입니다.

사실 모델을 학습시키는데 있어서 강화학습 방법론과 지도학습 방법론을 명확히 구분짓는것은 상당히 모호하기도 합니다. 강화학습 알고리즘 역시 주어진 입력에 대해서 최적의 행동을 classification하는 형태로 학습이 진행되기 때문입니다.  하지만, 앞서 설명드린것과 같이 **강화학습은 행동의 순서와 시간을 포괄하여 학습하기 때문에 current reward을 최대화하는 행동을 선택하는 것이 아닌, long-term cumulative rewards을 최대화하는 행동을 선택하는 방향으로 학습을 진행하게 됩니다.** 

## Why should we learn deep reinforcement learning?

사실 강화학습이라는 분야는 상당히 오랜시간 동안 외면 받아왔던 연구 분야입니다. 그렇다면 도대체 어떠한 요인들로 인해 강화학습이 각광받게 되었을까요? Levine교수님은 3가지 이유를 제시합니다.
